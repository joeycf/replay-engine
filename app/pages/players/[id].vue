...
<template>
  <div class="mx-auto w-full max-w-[1440px]">
    ...
    >
      ...
      <div class="relative flex flex-wrap items-center gap-5 md:gap-[26px]">
        ...
        <div class="min-w-0">
          ...
          <dl v-if="extraRows.length" class="mt-2 flex flex-wrap gap-x-5 gap-y-1">
            <div v-for="[k, v] in extraRows" :key="k" class="flex items-baseline gap-1.5">
        ...
        <div class="ml-auto flex gap-3.5">
          ...
          <div class="w-px bg-border" aria-hidden="true" />
          <div class="text-right">
    ...
    <div class="grid grid-cols-1 gap-4 px-4 py-[22px] md:grid-cols-2 md:px-7">
      ...
      <section v-if="showDuo" class="border border-border-subtle bg-surface p-5">
        <h2 class="mb-4 font-ui text-[10px] font-semibold uppercase tracking-label text-text-muted">
          Signature pairings
        </h2>
