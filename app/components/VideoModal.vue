      ...
      >
        ...
        >
          ...
          <div class="flex items-center gap-3 px-4 py-3 md:hidden">
            ...
            <SourceBadge v-if="replay" :source="replay.source" class="ml-auto" />
          </div>

          <!-- desktop top bar -->
          <div class="hidden items-center gap-3 border-b border-border-subtle px-5 py-3.5 md:flex">
            <SourceBadge v-if="replay" :source="replay.source" size="md" />
          ...
          <template v-if="replay">
            <LiteYouTube :video-id="replay.id" :thumbnail="thumbOf(replay)" :title="replay.title" />
                  ...
                  <div class="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div class="mt-[3px] inline-flex items-center gap-1.5">
                        <VerifiedMark v-if="isFeatured(sideA)" :size="10" />
          ...
          <template v-else>
            ...
            <div v-if="pending" class="p-6 text-center font-mono text-[12px] text-text-muted">
              Loading replay…
            </div>
