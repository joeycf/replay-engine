...
import type { PairRow } from '../composables/useStatsRows';
...
<template>
  ...
  <div v-if="boxed" ref="root" data-testid="pairing-bars" class="flex flex-col gap-[11px]">
    ...
    >
      <div class="flex">
        <CharacterBadge :character-id="p.a" :size="28" :notch="6" :font-size="10" />
        <CharacterBadge :character-id="p.b" :size="28" :notch="6" :font-size="10" class="-ml-1.5" />
      </div>
  ...
  <div v-else-if="soloFor" ref="root" data-testid="pairing-bars" class="flex flex-col gap-3">
    ...
    >
      <div class="mb-[5px] flex items-center gap-2">
        <CharacterBadge :character-id="mateOf(p)" :size="24" :notch="6" :font-size="10" />
  ...
  <div v-else ref="root" data-testid="pairing-bars" class="flex flex-col gap-[11px] md:gap-3">
    ...
    >
      <div class="mb-[5px] flex items-center gap-2 md:gap-[9px]">
        <div class="flex">
          <CharacterBadge :character-id="p.a" :size="24" :notch="6" :font-size="10" />
          <CharacterBadge
            :character-id="p.b"
            :size="24"
            :notch="6"
